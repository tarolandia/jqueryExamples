...
<html lang="en">
    <head>
        <title>jQuery 1.5 examples: Example 2</title>
    ...
    <body>
        <h1>Example 2: Simple animation </h1><br>
        <a href="index.php"> << BACK </a><br>
        <br>
        <div style="height: 500px;width: 500px; position: relative">
            <input type="button" value="Start" id="startBtn" />&nbsp;Each click -> one lap. Try it!
        ...
        step = 0;
            $(document).ready(function(){
                ...
                $("#startBtn").click(function(){
                    $.when( next_step(step+1) ).then(next_step(step+1)).then(next_step(step+1)).then(next_step(step+1));
                });            
            });
